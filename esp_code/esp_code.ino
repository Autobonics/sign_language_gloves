...
sensorMax4=flexADC4;
  ...
  Serial.print("Waiting for callib..");
  lcd.clear();
  lcd.setCursor(0,0);
  lcd.print("Waiting for callib..");
  }
}

  lcd.clear();
  lcd.setCursor(0,0);
  lcd.print("Sign recognition");
}
...
xadc = map(xR, xmin, xmax, 0, 180);
yadc = map(yR, ymin, ymax, 0, 180);
